...
function App() {
    ...
    useEffect(() => {
        ...
        const from_main_set_progress = (data) => {
            console.log('======= 来自from_main_set_progress =========');
            console.log(data);
            if(data){
          ...
          window.api.on("from_main_set_progress", from_main_set_progress);
          ...
          return () => {
            ...
            window.api.off("from_main_set_progress");
          };
    ...
    const handleParse = async () => {
        ...
        if (result) {
            ...
            console.log('const result = await window.api.selectPdf();', result)
            // let html = del_html(result)
            let {status, data, cell,email, name} =  result;
            ...
            if(status === 1){
                ...
                data = data.replace('vip@vip.com', email)
